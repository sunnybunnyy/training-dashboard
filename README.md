...
## Key Features:
- **Strava Integration**: Sync with Strava to import activities directly.
- **Custom Training Plans**: Users can create personalized training plans for races, with activities scheduled on specific days.
